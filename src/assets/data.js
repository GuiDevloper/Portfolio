const data = {
  options1: [
    [
      ['The Sea', 'The Inspiration', 'The Dreamity', 'The Portfolio'],
      ['Guilherme Strange', 'The Panther', 'The Sea Ilustrations']
    ],
    [
      [`<-`, 'Ver no GitHub', 'Ver Online']
    ],
    [
      [null, 'https://github.com/guidevloper/', 'https://guidevloper.github.io/']
    ]
  ],
  descriptions: [
    [
  ...
  imgs: [
    ...
    [
      [1, "/img/Inspiration-d.f81d39da.jpg"], [2, "/img/TheSea2.f70b81b5.jpg"],
      [1, "/img/TheSea.34953e45.jpg"], [2, "/img/Inspiration-w.170dfdd3.jpg"]
    ]
  ]
};
